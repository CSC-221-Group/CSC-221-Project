...
public class Screen extends JPanel implements ActionListener, KeyListener {
    ...
    private void resetBoard() {
        cells[0][0] = new Cell(0, 0, new Pawn("white", 0, 0, 1)); // ROOK
        cells[1][0] = new Cell(1, 0, new Pawn("white", 1, 0, 1)); // KNIGHT
        cells[2][0] = new Cell(2, 0, new Pawn("white", 2, 0, 1)); // BISHOP
        cells[3][0] = new Cell(3, 0, new Pawn("white", 3, 0, 1)); // QUEEN
        cells[4][0] = new Cell(4, 0, new Pawn("white", 4, 0, 1)); // KING
        cells[5][0] = new Cell(5, 0, new Pawn("white", 5, 0, 1)); // BISHOP
        cells[6][0] = new Cell(6, 0, new Pawn("white", 6, 0, 1)); // KNIGHT
        cells[7][0] = new Cell(7, 0, new Pawn("white", 7, 0, 1)); // ROOK
        for (int i = 0; i < 8; i++) {
        ...
        cells[4][7] = new Cell(4, 7, new Pawn("black", 4, 7, 2)); // KING
        cells[5][7] = new Cell(5, 7, new Pawn("black", 5, 7, 2)); // BISHOP
        cells[6][7] = new Cell(6, 7, new Pawn("black", 6, 7, 2)); // KNIGHT
        cells[7][7] = new Cell(7, 7, new Pawn("black", 7, 7, 2)); // ROOK
        for (int i = 0; i < 8; i++) {
